...
public class UserActivityDTO
{
	...
	public UserActivityDTO(String userName, String urlProfilePicture, Action userAction, String valueShortId,
			int amount, BigDecimal price, Date date)
	{
	...
	public UserActivityDTO(String userName, String urlProfilePicture, Action userAction, String valueShortId,
			int amount, BigDecimal price, LocalDateTime date)
	{
		this.userName = userName;
		this.urlProfilePicture = urlProfilePicture;
		this.userAction = userAction;
